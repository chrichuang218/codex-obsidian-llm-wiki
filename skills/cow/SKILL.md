---
name: cow
description: Entry point for Codex Obsidian Wiki commands. Use when the user types cow, cow help, cow init, cow ingest, cow batch, cow query, cow lint, cow graph, or cow review and wants to work with an Obsidian-compatible Markdown LLM Wiki.
---
