---
name: cow-help
description: Show the Codex Obsidian Wiki command cheatsheet. Use when the user asks for cow help, COW help, Codex Obsidian Wiki commands, or how to use the cow commands.
---

# Cow Help

Show this concise cheatsheet:
...
cow help                               Show this cheatsheet.
```

Mention that these are skill trigger phrases, not Codex slash commands.
